...
#dropdown{position:absolute;top:calc(100% + 4px);left:0;right:90px;background:var(--surface2);border:1px solid var(--border);border-radius:8px;max-height:240px;overflow-y:auto;display:none;z-index:100;box-shadow:0 8px 24px rgba(0,0,0,.5)}
.dd-item{padding:10px 14px;cursor:pointer;font-size:13px;color:var(--text);display:flex;flex-direction:column;gap:2px}
...
const CHARS=[
  {name:"Jonathan Joestar",part:1,stand:false,standName:null,standType:"None",nationality:"British",role:"Protagonist",hair:"Brown",img:"https://upload.wikimedia.org/wikipedia/en/3/38/Jonathan_Joestar_anime.png",emoji:"🎩"},
  {name:"Robert E.O. Speedwagon",part:1,stand:false,standName:null,standType:"None",nationality:"British",role:"Ally",hair:"Blond",img:null,emoji:"🎩"},
  {name:"Dio Brando",part:1,stand:true,standName:"The World",standType:"Close-Range",nationality:"British",role:"Villain",hair:"Blond",img:"https://upload.wikimedia.org/wikipedia/en/7/75/DIO_anime.png",emoji:"🧛"},
  {name:"Will A. Zeppeli",part:1,stand:false,standName:null,standType:"None",nationality:"Italian",role:"Ally",hair:"Brown",img:null,emoji:"🎩"},
  {name:"Erina Pendleton",part:1,stand:false,standName:null,standType:"None",nationality:"British",role:"Ally",hair:"Brown",img:null,emoji:"💐"},
  {name:"Joseph Joestar",part:2,stand:true,standName:"Hermit Purple",standType:"Close-Range",nationality:"British",role:"Protagonist",hair:"Brown",img:"https://upload.wikimedia.org/wikipedia/en/5/52/Joseph_Joestar_anime.png",emoji:"🔮"},
  {name:"Caesar Anthonio Zeppeli",part:2,stand:false,standName:null,standType:"None",nationality:"Italian",role:"Ally",hair:"Blond",img:null,emoji:"🫧"},
  {name:"Lisa Lisa",part:2,stand:false,standName:null,standType:"None",nationality:"American",role:"Ally",hair:"Black",img:null,emoji:"🌹"},
  {name:"Kars",part:2,stand:false,standName:null,standType:"None",nationality:"Other",role:"Villain",hair:"Black",img:null,emoji:"🌙"},
  {name:"Wamuu",part:2,stand:false,standName:null,standType:"None",nationality:"Other",role:"Villain",hair:"White",img:null,emoji:"💨"},
  {name:"Jotaro Kujo",part:3,stand:true,standName:"Star Platinum",standType:"Close-Range",nationality:"Japanese",role:"Protagonist",hair:"Black",img:"https://upload.wikimedia.org/wikipedia/en/1/12/Jotaro_Kujo_anime.png",emoji:"⭐"},
  {name:"Noriaki Kakyoin",part:3,stand:true,standName:"Hierophant Green",standType:"Long-Range",nationality:"Japanese",role:"Ally",hair:"Red",img:null,emoji:"🕸️"},
  {name:"Jean Pierre Polnareff",part:3,stand:true,standName:"Silver Chariot",standType:"Close-Range",nationality:"French",role:"Ally",hair:"Silver",img:null,emoji:"⚔️"},
  {name:"Muhammad Avdol",part:3,stand:true,standName:"Magician's Red",standType:"Close-Range",nationality:"Egyptian",role:"Ally",hair:"Black",img:null,emoji:"🔥"},
  {name:"Iggy",part:3,stand:true,standName:"The Fool",standType:"Close-Range",nationality:"American",role:"Ally",hair:"Black",img:null,emoji:"🐶"},
  {name:"DIO",part:3,stand:true,standName:"The World",standType:"Close-Range",nationality:"British",role:"Villain",hair:"Blond",img:"https://upload.wikimedia.org/wikipedia/en/7/75/DIO_anime.png",emoji:"🧛"},
  {name:"Josuke Higashikata",part:4,stand:true,standName:"Crazy Diamond",standType:"Close-Range",nationality:"Japanese",role:"Protagonist",hair:"Black",img:"https://upload.wikimedia.org/wikipedia/en/a/a3/Josuke_Higashikata_anime.png",emoji:"💎"},
  {name:"Koichi Hirose",part:4,stand:true,standName:"Echoes",standType:"Close-Range",nationality:"Japanese",role:"Ally",hair:"Brown",img:null,emoji:"🥚"},
  {name:"Okuyasu Nijimura",part:4,stand:true,standName:"The Hand",standType:"Close-Range",nationality:"Japanese",role:"Ally",hair:"Black",img:null,emoji:"✋"},
  {name:"Rohan Kishibe",part:4,stand:true,standName:"Heaven's Door",standType:"Close-Range",nationality:"Japanese",role:"Neutral",hair:"Black",img:null,emoji:"📖"},
  {name:"Yoshikage Kira",part:4,stand:true,standName:"Killer Queen",standType:"Close-Range",nationality:"Japanese",role:"Villain",hair:"Blond",img:null,emoji:"💣"},
  {name:"Giorno Giovanna",part:5,stand:true,standName:"Gold Experience",standType:"Close-Range",nationality:"Italian",role:"Protagonist",hair:"Blond",img:"https://upload.wikimedia.org/wikipedia/en/3/33/Giorno_Giovanna_anime.png",emoji:"🌿"},
  {name:"Bruno Bucciarati",part:5,stand:true,standName:"Sticky Fingers",standType:"Close-Range",nationality:"Italian",role:"Ally",hair:"Black",img:null,emoji:"🤐"},
  {name:"Guido Mista",part:5,stand:true,standName:"Sex Pistols",standType:"Long-Range",nationality:"Italian",role:"Ally",hair:"Black",img:null,emoji:"🔫"},
  {name:"Narancia Ghirga",part:5,stand:true,standName:"Aerosmith",standType:"Long-Range",nationality:"Italian",role:"Ally",hair:"Black",img:null,emoji:"✈️"},
  {name:"Pannacotta Fugo",part:5,stand:true,standName:"Purple Haze",standType:"Close-Range",nationality:"Italian",role:"Ally",hair:"Blond",img:null,emoji:"☣️"},
  {name:"Trish Una",part:5,stand:true,standName:"Spice Girl",standType:"Close-Range",nationality:"Italian",role:"Ally",hair:"Pink",img:null,emoji:"💅"},
  {name:"Diavolo",part:5,stand:true,standName:"King Crimson",standType:"Close-Range",nationality:"Italian",role:"Villain",hair:"Pink",img:null,emoji:"👁️"},
  {name:"Jolyne Cujoh",part:6,stand:true,standName:"Stone Free",standType:"Close-Range",nationality:"American",role:"Protagonist",hair:"Green",img:"https://upload.wikimedia.org/wikipedia/en/b/b6/Jolyne_Cujoh_anime.png",emoji:"🧵"},
  {name:"Hermes Costello",part:6,stand:true,standName:"Kiss",standType:"Close-Range",nationality:"American",role:"Ally",hair:"Black",img:null,emoji:"💋"},
  ...
  {name:"Yasuho Hirose",part:8,stand:true,standName:"Paisley Park",standType:"Remote",nationality:"Japanese",role:"Ally",hair:"Pink",img:null,emoji:"🌸"},
  {name:"Norisuke Higashikata IV",part:8,stand:true,standName:"King Nothing",standType:"Close-Range",nationality:"Japanese",role:"Ally",hair:"Brown",img:null,emoji:"🔍"},
  {name:"Tooru",part:8,stand:true,standName:"Wonder of U",standType:"Automatic",nationality:"Japanese",role:"Villain",hair:"Silver",img:null,emoji:"♾️"},
];
...
searchEl.addEventListener("input",()=>{
  ...
  dropdown.innerHTML=hits.slice(0,10).map((c,i)=>{
    const standLabel=c.stand?`<span class="dd-stand-label">Stand: ${c.standName}</span>`:`<span class="dd-stand-label">No Stand</span>`;
    return`<div class="dd-item" data-name="${c.name}" data-i="${i}">${c.name}${standLabel}</div>`;
  }).join("");
